...
open class EVURLCache: URLCache {
    ...
    open static var MAX_FILE_SIZE = 16 * 1024 * 1024 // The maximum file size that will be cached (16 * 1024 * 1024Bytes = 16MB)
    open static var MAX_CACHE_SIZE = 256 * 1024 * 1024 // The maximum file size that will be cached (256 * 1024 * 1024Bytes = 256MB)
